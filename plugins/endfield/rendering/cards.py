...
from ..catalog.skill_metrics import fz_metric_replaces_generic, is_generic_fz_metric
from ..paths import IMAGE_DIR as ASSET_DIR
...
def _substitute_weapon_placeholders(template: str, values: dict[str, object]) -> str:
    from ..catalog.service import _substitute_fz_placeholders
