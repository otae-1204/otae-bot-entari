"""Personal challenge data models and fixed-size account cards.

The public challenge endpoints are deliberately kept out of the shared stage
models.  They contain a player's records, team snapshots and visibility state,
so this module owns normalization, conservative name resolution and rendering.
"""
...
from .account_challenge_i18n import ChallengeLocale
...
WAR_RATING_ASSET_DIR = Path(__file__).resolve().parents[2] / "assets" / "image" / "endfield" / "challenges" / "war_rating"
# 轮换关卡组的官方三星素材：未点亮 / 点亮 / 点亮且追加目标全完成（金色六芒变体）。
WAR_STAR_ASSET_DIR = Path(__file__).resolve().parents[2] / "assets" / "image" / "endfield" / "challenges" / "war_star"
...
WAR_PLATE_ASSET = Path(__file__).resolve().parents[2] / "assets" / "image" / "endfield" / "challenges" / "war_plate" / "degree.png"
...
POTENTIAL_ICON_DIR = Path(__file__).resolve().parent / "assets" / "ui"
WAR_RATING_FILES = {
    "unrated": "unrated.png",
    "d": "d.png",
    "c": "c.png",
