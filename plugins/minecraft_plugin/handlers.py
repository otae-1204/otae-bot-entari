...
from otae_bot.adapters.entari import cmd as _cmd, get_rest, get_bot
...
from plugins.minecraft_plugin.ping import ping
from otae_bot.adapters.entari import on_alconna
